...
- Active test blocks: 3273
- Ignored/manual test blocks: 140
- Declared test blocks: 3413
- Weighted coverage points: 2679.9
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| windows | 29 | 3137 | 132 | 2617.7 | 21 | 11 | 100% |
| macos | 29 | 3192 | 115 | 2628.9 | 22 | 11 | 100% |
| linux | 25 | 2809 | 105 | 2318.9 | 20 | 11 | 100% |

## Crate Summary

| Crate | Suites | Integration files | Source unit files | Active tests | Ignored tests | Weighted points | Flows |
| --- | --- | --- | --- | --- | --- | --- | --- |
| screenpipe-engine | 10 | 19 | 117 | 1612 | 42 | 1229.7 | 10 |
...
| screenpipe-a11y | 4 | 2 | 28 | 340 | 30 | 251.5 | 3 |
...
| --- | --- | --- | --- |
| accessibility | 4 suites / 345 active / 29 ignored / 316.5 pts | 4 suites / 396 active / 12 ignored / 322.2 pts | 4 suites / 323 active / 7 ignored / 295.5 pts |
...
| local-api | 2 suites / 420 active / 9 ignored / 296.1 pts | 2 suites / 420 active / 9 ignored / 296.1 pts | 2 suites / 420 active / 9 ignored / 296.1 pts |
| meeting | 6 suites / 1548 active / 19 ignored / 1254.9 pts | 6 suites / 1548 active / 19 ignored / 1254.9 pts | 4 suites / 1253 active / 15 ignored / 982.4 pts |
...
| performance | 13 suites / 1423 active / 67 ignored / 1251.9 pts | 14 suites / 1523 active / 73 ignored / 1291.9 pts | 13 suites / 1423 active / 67 ignored / 1251.9 pts |
| pipes | 1 suites / 489 active / 3 ignored / 342.3 pts | 1 suites / 489 active / 3 ignored / 342.3 pts | 1 suites / 489 active / 3 ignored / 342.3 pts |
| privacy | 5 suites / 910 active / 36 ignored / 738.4 pts | 5 suites / 961 active / 19 ignored / 744.1 pts | 5 suites / 888 active / 14 ignored / 717.3 pts |
| real-app | - | 1 suites / 100 active / 6 ignored / 40.0 pts | - |
...
| sync | 1 suites / 489 active / 3 ignored / 342.3 pts | 1 suites / 489 active / 3 ignored / 342.3 pts | 1 suites / 489 active / 3 ignored / 342.3 pts |
| timeline | 4 suites / 1073 active / 33 ignored / 862.1 pts | 4 suites / 1073 active / 33 ignored / 862.1 pts | 4 suites / 1073 active / 33 ignored / 862.1 pts |
| transcription | 5 suites / 795 active / 40 ignored / 620.0 pts | 5 suites / 795 active / 40 ignored / 620.0 pts | 5 suites / 795 active / 40 ignored / 620.0 pts |
| ui-events | 4 suites / 729 active / 28 ignored / 553.8 pts | 3 suites / 680 active / 5 ignored / 519.5 pts | 3 suites / 680 active / 5 ignored / 519.5 pts |
...
| a11y-macos-tree | screenpipe-a11y | macos | accessibility, privacy, real-app, performance | accessibility-ui-events, privacy-and-redaction, performance-liveness | high | conditional | mixed | 6 | 100 | 6 | macOS AX unit coverage plus real TextEdit/Finder/Obsidian probes. Obsidian tests are ignored by default because they require a local app install and AX permission. |
...
| engine-api-routes | screenpipe-engine | windows, macos, linux | local-api, timeline, meeting, transcription | local-api-search, timeline-streaming, meeting-live-notes, audio-record-transcribe | high | partial | mixed | 42 | 413 | 4 | Route/unit coverage for search, health, streaming, meetings, time/timezone, and transcription. Legacy endpoint/websocket tests require local data and remain ignored. |
...
| engine-meeting-privacy-sync | screenpipe-engine | windows, macos, linux | meeting, privacy, ui-events, pipes, sync | meeting-live-notes, privacy-and-redaction, accessibility-ui-events, performance-liveness | medium | strong | unit | 32 | 489 | 3 | Unit-heavy coverage for privacy filter policy, capture exclusions, UI recorder safety, pipes/live-view/structured-output helpers, sync helpers, and CLI parsing. Meeting detection moved to the engine-meeting-watcher suite. |
...
| a11y-macos-tree | screenpipe-a11y | src/platform/macos.rs | source | 18 | 3 | 21 |
