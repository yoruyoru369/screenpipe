...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-none p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-neutral-300 group-[.destructive]:hover:text-neutral-50 group-[.destructive]:focus:ring-neutral-400 group-[.destructive]:focus:ring-offset-neutral-600",
      className
    )}
    toast-close=""
    {...props}
